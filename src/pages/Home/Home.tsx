      ...
      <div className={s.home} ref={refHome}>
         <h1>
            ...
            <span className={s.hi_box}>
               <svg className={s.hi} viewBox="0 0 88 57" xmlns="http://www.w3.org/2000/svg">
               ...
               <div  className={s.box_hi_text}>
                  <span className={s.hi_text}>HI!</span>
               </div>
            </span>
         </h1>
         <p className='gray'>{t("Hi, I'm Andrii Priadko. A passionate Full-stack Developer based in Ukraine.")}<img src={ukImg} alt='UK' /></p>
         <div className={s.row}>
